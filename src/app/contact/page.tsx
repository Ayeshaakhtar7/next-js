               ...
               <h1 className="text-top-2">Contact information</h1>
                   <div className="inform-box">
                      ...
                      <p className="parent-box"> <span className="country-data">Country:</span> <span className="adrees">Pakistan</span></p>
                       ...
                       <p className="parent-box"> <span className="country-data">Area:</span>  <span className="adrees">Quaidabad</span></p>
                      </div>
                   </div>
                   ...
                   <div className="box-information2">
                     <p className="parent-box"> <span className="country-data">Email:</span> <span className="adrees">ayeshaakhtar794@gmail.com</span></p>
                       <p className="parent-box"> <span className="country-data">Youtube:</span>    <span className="adrees"> IT Academy</span></p>
                       <p className="parent-box"> <span className="country-data">Facebook:</span>  <span className="adrees">Ayesha Rana</span></p>
                     </div>
                   </div>
                   ...
                   <div className="box-information2">
                      <p className="parent-box"> <span className="country-data">Support services:</span> <span className="adrees">99919</span></p>
                       <p className="parent-box"> <span className="country-data">Office:</span>    <span className="adrees"> 021.000000</span></p>
                       <p className="parent-box"> <span className="country-data">Personal:</span>  <span className="adrees">0316.0000000</span></p>
                      </div>
                   </div>
